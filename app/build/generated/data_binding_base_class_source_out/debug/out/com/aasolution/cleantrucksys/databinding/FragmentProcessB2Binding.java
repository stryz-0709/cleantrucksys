...
public final class FragmentProcessB2Binding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentProcessB2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentProcessB2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_process_b2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentProcessB2Binding bind(@NonNull View rootView) {
