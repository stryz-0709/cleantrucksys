...
public final class FragmentProcessB1Binding implements ViewBinding {
  @NonNull
  ...
  private FragmentProcessB1Binding(@NonNull FrameLayout rootView,
      ...
      @NonNull ToggleButton valve6Light, @NonNull ImageView valve8Gradient,
      @NonNull ToggleButton valve8Light, @NonNull ImageView valve9Gradient,
  ...
  @NonNull
  public static FragmentProcessB1Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentProcessB1Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_process_b1, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentProcessB1Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProcessB1Binding((FrameLayout) rootView, ConstraintLayout, backButton,
          ...
          valve4Gradient, valve4Light, valve6Gradient, valve6Light, valve8Gradient, valve8Light,
          valve9Gradient, valve9Light, waterGradient, waterLight, zoomInButton, zoomOutButton);
    }
