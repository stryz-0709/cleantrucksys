...
public class ProcessA2 extends Fragment {
    ...
    ToggleButton startProcessA2, stopProcessA2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        startProcessA2 = mView.findViewById(R.id.start_process_button);
        stopProcessA2 = mView.findViewById(R.id.stop_process_button);
        ...
        startProcessA2.setOnClickListener(v -> updateProcess(startProcessA2, stopProcessA2, "process", null));
        stopProcessA2.setOnClickListener(v -> updateProcess(startProcessA2, stopProcessA2, "process", null));
    ...
    private void updateProcess(ToggleButton startButton, ToggleButton stopButton, String key, JSONObject jsonObject) {
        try {
            ...
            if (jsonObject != null) {
                ...
                isProcessActive = jsonObject.has(key) && jsonObject.getInt(key) == 2; // 2 indicates "active"
            } else {
                ...
                jsonData.put(key, isProcessActive ? 2 : 0); // 2 for start, 0 for stop
            ...
            Log.e("ProcessA2", "Error handling process state for key: " + key, e);
        }
    }
...
//            oilGradient.setVisibility(jsonObject.getInt("oil_power") == 1? VISIBLE: GONE);
            ...
            Log.e("ProcessA2", "Error updating lights", e);
        }
    }
            ...
            public void onResponse(String response) {
                ...
                requireActivity().runOnUiThread(() -> {
                    try {
                        ...
                        Log.d("ProcessA2", "Received JSON: " + jsonObject.toString());

                        updateLights(jsonObject);
                        updateProcess(startProcessA2, stopProcessA2, "process", jsonObject);

                    } catch (JSONException e) {
                        Log.e("ProcessA2", "Error parsing JSON response", e);
                    }
                });
            }
